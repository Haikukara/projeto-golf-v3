...
import { PlayersList, PlayersInsert, PlayersUpdate, MatchesList, MatchesInsert, MatchShow, HandicapruleUpdate, HandicapruleList, MatchesUpdate } from '../pages';
    ...
    return (
        <Router>
              ...
              <Switch>
                  ...
                  <Route path="/matches/update/:id" exact component={MatchesUpdate} />
              </Switch>
              <Footer />
        </Router>
    )
